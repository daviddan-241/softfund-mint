...
(function () {
  ...
  let minted = 5; // show 5 people minted initially
  let quantity = 1;
  let SOL_PRICE = 150;
  ...
  mintBtn.addEventListener('click', async ()=>{
    ...
    if(!confirm(`Send ${totalSOL.toFixed(6)} SOL to treasury? Approve in wallet.`)) return;
